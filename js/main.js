...
function CreateBasicDomTree() {
    ...
    for (let i = 0; i < 20; i++) {
        const html = `<div class="movie-item flex-item bg-gray margin-10">
                ...
                <div class="movie-second-div dp-column-flex">
                    ...
                    <div class="movie-overview"><span class="movie-overview-text margin-10 dp-none"></span></div>
                </div>
...
container.addEventListener("click", function (event) {
    ...
    if (event.target.classList.contains("movie-image")) {
        ...
        console.log(second_divs[3].innerText);
